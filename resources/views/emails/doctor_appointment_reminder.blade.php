...
<div class="container">
    ...
    <p>Dear {{ $appointment->doctor->user->name }}!</p>
    <p>This is a reminder for your appointment with {{ $appointment->patient->user->name }} . Please make sure to Start the Zoom meeting at the scheduled time.</p>
    <p>Date: {{ $appointment->appointment_date }}</p>
    <p>Time: {{ $appointment->appointment_time }}</p>
    <p>We look forward to seeing you soon!</p>
    <div class="zoom-link">
      <a class="button" href="{{$appointment->zoom_start_url}}">Join Zoom Meeting</a>
    </div>
  </div>
 </div>
