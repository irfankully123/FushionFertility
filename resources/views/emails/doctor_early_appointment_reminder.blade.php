...
<head>
    ...
    <title>Please Download Zoom Before Appointment Meeting</title>
    <style>
...
<div class="container">
    ...
    <div class="card" style="background: white; color: black; border: 1px solid black; margin-top: 25px;">
        ...
        <p>This is a reminder for your appointment with {{ $appointment->patient->user->name }} . Please make sure to Download Zoom </p>
