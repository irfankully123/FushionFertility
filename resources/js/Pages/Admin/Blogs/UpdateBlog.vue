...
onMounted(() => {
    form.author = props.blog.author_name;
    form.title = props.blog.title;
    const category = props.categories.find(category => category.id === props.blog.blog_category_id);
    form.category = category ? category.category_name : '';
    form.content=props.blog.content;
    form.id=props.blog.id;
});
    ...
    <Layout>
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <form @submit.prevent="form.post(route('dashboard.blog.update'))">
                    <div class="card-body">
                        <div class="mb-3">
                            <img v-if="imageState.image" :src="imageState.image" width="200" height="200" alt="blog">
                            <img v-else-if="props.image!==null" :src="`/storage/blogs/${props.blog.image}`" width="200" height="200" alt="blog">
                            <img v-else src="https://i0.wp.com/roadmap-tech.com/wp-content/uploads/2019/04/placeholder-image.jpg?fit=1200%2C900&ssl=1" width="200" height="200" alt="Placeholder">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <select v-model="form.category" class="form-select" id="category">
                                    ...
                                    <option v-for="(category,index) in props.categories" :key="index">
