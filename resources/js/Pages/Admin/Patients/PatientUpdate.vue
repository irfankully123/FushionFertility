...
import Image_Preview from '@/Components/UploadPicture.vue'
...
const handleUpdate = () => {
    form.post(route('dashboard.patients.update', props.patient.id), {
        preserveScroll: true,
        onSuccess: () => {
...
onMounted(() => {
    ...
    form.contact = props.patient.contact;
    form.blood_group = props.patient.blood_group;
    form.gender = props.patient.gender;
    form.age = props.patient.age;
    form.address = props.patient.address;
    form.zip_code = props.patient.zip_code;
    form.dob = props.patient.dob;
    form.city = props.patient.city;
    form.state = props.patient.state;
    form.primary_care_physician = props.patient.primary_care_physician;
    form.medical_history = props.patient.medical_history;
    form.current_medications = props.patient.current_medications;
});
    ...
    <Layout>
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <h5 class="float-end">
                    <Link :href="route('dashboard.patients')">Back</Link>
                </h5>
            </div>
            <div class="card-body">
                <Image_Preview :image="props.user.profile" @image="(file) => form.profile = file"
                               :errorMessage="form.errors.profile">
                </Image_Preview>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text border-primary"><i class='bx bxs-user'></i></span>
                                <input v-model="form.name" type="text" class="form-control border-primary"
                                       placeholder="name" id="name" autocomplete="true" />
                            </div>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input v-model="form.email" type="email" class="form-control border-primary"
                                       placeholder="example@gmail.com" id="email" autocomplete="true">
                            </div>
                    ...
                    <div class="col-4">
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text border-primary"><i class='bx bxs-contact'></i></span>
                    ...
                    <div class="col-4">
                        <div class="form-group mt-3">
                            <label class="form-label" for="blood-group">Blood Group <span
                                class="text-danger">*</span></label>
                            <div class="input-group input-group-merge">
                                <span class="input-group-text border-primary"><i class='bx bxs-donate-blood'></i></span>
                                <select v-model="form.blood_group" class="form-select border-primary" name="gender"
                                        id="blood-group">
                    ...
                    <div class="col-4">
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text border-primary"><i class='bx bx-male-sign fw-bold'></i></span>
                    ...
                    <div class="col-4">
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text border-primary"><i class='bx bxs-location-plus'></i></span>
                    ...
                    <div class="col-4">
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group input-group-merge">
                                <textarea v-model="form.primary_care_physician" name="physician"
                                          class="form-control border-primary" cols="30" rows="4"
                                          id="primary-care-physician"></textarea>
                            </div>
                    ...
                    <div class="col-4">
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group input-group-merge">
                                <textarea v-model="form.medical_history" name="medical" class="form-control border-primary" cols="30" rows="4" id="medical-history"></textarea>
                            </div>
                    ...
                    <div class="col-4">
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group input-group-merge">
                                <textarea v-model="form.current_medications" name="medications"
                                          class="form-control border-primary" cols="30" rows="4"
                                          id="current-medications"></textarea>
                            </div>
                            <span v-if="form.errors.current_medications" class="text-danger">{{
                                    form.errors.current_medications }}</span>
                        </div>
                    </div>
                    <div class="col-12 text-end mt-3">
                        <SpinnerButton @click="handleUpdate" class="btn btn-primary" type="submit"
